...
function Person({
    ...
    return (
        <div className="from-rose-100 to-rose-200 bg-gradient-to-br hover:from-rose-200 hover:to-rose-400 flex flex-col gap-3 justify-between items-center p-2 rounded-lg shadow-lg hover:shadow-2xl">
            ...
            <div className="w-full flex gap-3 justify-between items-center flex-col">
